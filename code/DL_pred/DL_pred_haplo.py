...
print(f"Type: haplo\t\tML_model: {DL_model}\t\tSNP_type: {SNP_type}\t\ttrait: {trait}\t\tyear:{year}")
...
# 设置路径模板
train_test_sets = [(fr"{base_path}/{SNP_type}/{trait}/Train/train{i+1}.{SNP_type}.{trait}{year}.p_2.ped",
                    fr"{base_path}/{SNP_type}/{trait}/Test/test{i+1}.{SNP_type}.{trait}{year}.p_2.ped",
